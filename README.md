...
- [pydantic-ai](https://github.com/ezhuk/modbus-mcp/tree/main/examples/pydantic-ai) - demonstrates how to connect to the Modbus MCP server using the [PydanticAI Agent Framework](https://ai.pydantic.dev).
